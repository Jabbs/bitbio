class Project < ActiveRecord::Base
  ...
  PROTOCOLS = ["Alignment", "Allele-specific transcription", "Alternative Splicing", "Ancient DNA", "Antibody production", "Antibody purification", "Atomic force microscopy (AFM)", "Bioinformatics", "Bisulfite Sequencing", "Cancer biology", "Cell based assay", "ChIP-Seq", "ChIP-Seq Analysis", "ChIP-on-chip", "Chromatin immunoprecipitation (ChIP) sequencing", "Chromosome Walking", "Clone verification", "Cloning molecular constructs", "Comparative genomics", "Comparative transcriptomics", "Compound synthesis", "Computational Biology", "Confocal microscopy", "Consulting", "Copy number estimation", "Copy number variation (CNV) analysis", "Cytometry", "DNA Sequencing", "DNA fragment analysis", "DNA library screen", "DNA methylation", "DNA microarray", "DNA-Seq", "De novo assembly", "De novo sequencing", "De novo transcriptome assembly", "Differential Expression", "Differential methylated regions identification", "Digital microscopy", "Electron microscopy", "Enzyme-linked immunosorbent assay (ELISA)", "Epigenomics", "Exome analysis", "Exome and whole genome variant detection", "Experimental design", "Flow cytometry", "Flow cytometry data analysis", "Fluorescence microscopy", "Fluorescence-activated cell sorting (FACS)", "Functional Genomics", "Fusion genes", "Fusion transcripts", "Gene Expression Analysis", "Gene annotation retrieval", "Gene expression", "Gene finding", "Gene regulation", "Gene structure and RNA splicing", "Gene synthesis", "General bioinformatics (pipeline)", "Genetic variation", "Genome Wide Association Studies", "Genomic Assembly", "Genomic DNA amplification", "Genomic DNA extraction", "Genotype and phenotype", "Genotyping", "Genotyping by PCR", "Glycoprotein", "High performance computing", "High throughput screening (HTS)", "High-throughput screening", "High-throughput sequencing", "Histology", "Homology", "Image analysis", "Imaging", "Immunofluorescence", "Immunohistochemistry", "Immunostaining", "In situ hybridization (ISH)", "In vitro selection", "InDel discovery", "Instrumentation", "Integrated solution", "Inverted microscopy", "Ion beam microscopy", "Laser capture microdissection", "Library generation for next-generation sequencing",
               "Liquid chromatography (LC)", "Liquid chromatography-mass spectrometry (LC-MS)", "Mass spectrometry", "Mass spectrometry data analysis", "MeDIP-Seq", "Media preparation", "Metabolic pathways", "Metabolic reconstruction", "Metabolomics", "Metagenomics", "Metagenomics data analysis", "Metatranscriptomics", "Method development", "Methylation analysis", "MiRNA", "MiRNA-Seq", "Microarray data analysis", "Microbial identification", "Microscopy", "Microscopy consulting", "Microscopy data analysis", "Microscopy image analysis", "Molecular biology", "Monoclonal antibody production", "Motif analysis", "Motif discovery", "Multidimensional protein identification technology (MudPIT)", "Multiphoton microscopy", "Mutations", "Mutations and regulatory sites", "NcRNAs", "New gene discovery", "Next-Generation Sequencing", "Next-Generation Sequencing data analysis", "Nuclear magnetic resonance (NMR)", "Nuclear magnetic resonance (NMR) data analysis", "Nucleosome Positioning", "Oligonucleotide synthesis", "Paraffin embedding of tissue", "Pathology", "Pathway analysis", "Pathways, networks and models", "Peptide synthesis", "Personal genomics", "Phylogenetics", "Plasmid DNA extraction", "Polyclonal antibody production", "Polymerase chain reaction (PCR)", "Population Genomics", "Protein digestion", "Protein expression", "Protein identification", "Protein interactions", "Protein purification", "Protein sequencing", "Protein structure analysis", "Proteomics", "Pyrosequencing", "Quality Control", "RNA Sequencing", "RNA extraction", "RNA microarray", "RNA purification", "RNA-Seq", "RNA-Seq Alignment", "RNA-Seq Quantitation", "Read alignment", "Recombinant IgG production", "Reference assembly", "Regulatory element annotation", "Regulatory genomics", "Regulatory genomics epigenomics", "Regulatory sites", "Resequencing", "SNP Annotation", "SNP discovery", "SRNA", "Sample processing", "Scanning Tunneling Microscopy", "Scanning electron microscopy (SEM)", "Scanning probe microscopy", "Sectioning of frozen tissue", "Sequence Quality Control", "Sequence alignment", "Sequence analysis", "Sequence assembly", "Sequence comparison", "Sequence motifs", "Serum testing", "Shotgun DNA sequencing", "Site directed mutagenesis", "Small RNA", "Software development", "Somatic mutations",
               "Spinning disk confocal microscopy", "Statistical Analysis", "Structural variation", "Structural variation discovery", "Systems biology", "Targeted assembly", "Targeted gene sequencing", "Targeted resequencing", "Tissue culture", "Transcription Factor Binding Site identification", "Transcription Factor analysis", "Transcription regulation", "Transgenic mouse development", "Transmission electron microscopy (TEM)", "Transmitted light microscopy", "Transposable Elements", "Viral genomics", "Viral metagenomics", "Virus production", "Whole Genome Resequencing", "Whole Genome Resequencing Analysis", "Whole exome sequencing", "Whole genome assembly", "Whole genome sequencing", "Widefield fluorescence microscopy", "Yeast one-hybrid", "Yeast two-hybrid", "cDNA library construction", "single molecule real time (SMRT) sequencing", "2D Spectra Acquisition and Interpretation", "2D-PAGE", "Amino Acid Analysis", "Animal Husbandry", "Assays and Measurements", "Assisted Reproductive Technologies (Rodent IVF, ICSI)", "Atom Probe Tomography", "Atomic Force Spectroscopy", "Behavioral Phenotyping", "BioBanking", "Biochemical Analysis", "Bioethics Consultation Support", "Cell Culture", "Cell Imaging", "Cell Sorting", "Clinical Assessment (Hematology, Clinical Chemistries, etc.)", "Clinical Imaging - Small Animal (X-ray, Ultrasound, microCAT, MRI)", "Computational - Application Development", "Computational - Bioinformatics", "Computational - Biostatistics", "Computational - High Performance Computing", "Confocal Microscopy", "Copy Number Variation (CNV)", "Cryo-Electron Microscopy", "Cytogenetics", "Data Analysis", "DNA Analysis", "Electron Microscopy", "Electrophysiology Services", "Embryo Cryopreservation & Recovery Services", "F.I.S.H.", "Fabrication",
               "Flow Cytometric Analysis", "Functional Brain Imaging", "Gel Chromatography", "Genomics", "Human Pathology Services - Diagnostics & Consultation", "In Situ Hybridization", "Laser Capture Microdissection", "Library Services", "Light Scattering", "Magnetic Resonance Imaging (MRI)", "Mass Spectrometry", "Microarray", "Molecular Construct Services", "Molecular Imaging", "Molecular Library Services", "Monoclonal Antibody", "Multiphoton Microscopy", "Necropsy", "Nuclear Magnetic Resonance (NMR)", "Nucleic Acid Extraction", "oligo synthesis", "Optical Imaging", "Outreach", "PCR Arrays", "Peptide Synthesis", "Phosphor Imaging", "Photolithography", "Protein Extraction/Purification", "Protocol Development/Clinical Trial Coordination", "Real-time qPCR", "Rheology", "RNA analysis", "RNA Integrity", "SDS-PAGE", "Sequencing - Capillary Sequencing", "Sequencing - DNA Sequencing", "Sequencing - Next Generation Sequencing (NGS)", "Sequencing - Protein Sequencing", "Sequencing - Pyrosequencing", "Single Crystal X-ray Pattern Analysis", "Small-Angle Neutron Scattering", "Spectroscopy", "Stem Cell Procurement", "Support Services - Audiovisual Support", "Support Services - Biological photography/Photomicrography", "Support Services - Central Laboratory Supply", "Support Services - Electronics & Fabrication Shop", "Support Services - Glass Washing/Autoclaving", "Support Services - Glassblowing", "Support Services - Graphic Services",
               "Support Services - Media Preparation", "Support Services - Print Shop/Document Center", "Support Services - Shared Instrumentation Oversight & Maintenance", "Surface Plasmon Resonance (SPR)", "Surgical Services", "Thermal Analysis", "Tissue Culture", "Transgenics", "Ultrasonic Imaging", "Veterinary Services", "Viral Vectors", "Virology", "Western Blot", "X-Ray Crystallography", "X-ray Diffraction and Scattering", "Xenograft / Xenotransplantation"]
